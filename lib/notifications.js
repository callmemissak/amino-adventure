...
async function sendEmailViaResend(userEmail, reminderData) {
  ...
  try {
    const result = await resend.emails.send({
      from: "noreply@peptide-atlas.com",
      to: userEmail,
      subject: `Peptide Atlas: ${reminderData.peptideName} Reminder`,
      html: emailHtml,
    });
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <a href="https://peptide-atlas.vercel.app/dashboard" class="button">
              Log Injection →
            </a>
          </div>

          <div class="footer">
            <p>Peptide Atlas — Research Tracking Platform</p>
